...
Then I click on the "OPPORTUNITY" page
...
Then I click on the "PRODUCTS WITH PURPOSE" page
...
Then I click on the "MAX GIVES BACK" page
...
Then I click on the "HELP CENTER" page
...
When I click on the Products tab
Then I select the "English" language from dropdown
And I Observe the product page banner in "English"
Then I select the "Spanish" language from dropdown
And I Observe the product page banner in "Spanish"
Then I select the "French" language from dropdown
...
Then I click on the product and then scroll down the page to the title "the meta switch weight management system"
